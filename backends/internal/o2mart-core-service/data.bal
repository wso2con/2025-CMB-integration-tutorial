...
isolated table<Customer> key (id) customers = table [
    {id: "C001", name: "Tharik Kanaka", email: "tharik@wso2.com", phone: "555-123-4567", loyalty: {points: 1250, expiryDate: "2025-07-31"}},
    {id: "C002", name: "Brian Holt", email: "brian@test.org", phone: "555-234-5678", loyalty: {points: 750, expiryDate: "2025-06-31"}},
    {id: "C003", name: "Clara Zhang", email: "clara@sample.net", phone: "555-345-6789", loyalty: {points: 2800, expiryDate: "2026-08-31"}},
